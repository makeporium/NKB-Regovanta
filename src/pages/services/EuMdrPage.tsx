          ...
          <div className="container mx-auto px-4 max-w-6xl py-16 grid lg:grid-cols-3 gap-12">
              ...
              <Section title="Deep Expertise in European CE Marking Compliance">
                ...
                <div className="my-8 rounded-2xl overflow-hidden bg-gray-100 border border-gray-200 aspect-[16/9] relative flex items-center justify-center group">
                  ...
                  <p className="text-gray-400 font-medium text-sm text-center px-4">
                    [Three professionals discuss at a table. A whiteboard displays "Marketing Plan" representing NKB Regovanta's EU MDR and IVDR consulting services]
                  </p>
                </div>
              </Section>
            ...
            <div className="space-y-8">
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                <h3 className="text-xl font-black text-[hsl(195_65%_20%)] mb-2">Meet NKB Regovanta's Consulting Experts</h3>
                <p className="text-sm text-gray-600 mb-6 pb-6 border-b border-gray-200">Our team includes former Notified Body reviewers, medical writers, auditors and regulatory consultants with decades of real world experience.</p>
                
                <div className="space-y-6">
                  {[
                    { name: "Kevin Butcher", title: "Principal Regulatory Consultant", img: "[Person in a dark suit]" },
                    { name: "Jane Arnold-Round, MSc", title: "Senior Principal Consultant, Regulatory", img: "[Person in blue patterned top]" },
                    ...
                    { name: "Thomas Miramond, PhD", title: "Senior Regulatory Consultant", img: "[Person in a suit with brown beard]" }
                  ].map((expert) => (
