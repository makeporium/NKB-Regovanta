...
export const Route = createFileRoute("/services/canada/health-canada-inspection-readiness-and-defense")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-inspection-readiness-and-defense" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-inspection-readiness-and-defense" }],
    scripts: [
      {
