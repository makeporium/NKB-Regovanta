...
export const Route = createFileRoute("/insights/fda-medical-device-inspections-in-2026-preparing-for-the-new-qmsr-framework")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/insights/fda-medical-device-inspections-in-2026-preparing-for-the-new-qmsr-framework" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/insights/fda-medical-device-inspections-in-2026-preparing-for-the-new-qmsr-framework" },
    ],
  }),
  component: Article,
});
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://www.nkbregovanta.com/insights/fda-medical-device-inspections-in-2026-preparing-for-the-new-qmsr-framework"
          })
        }}
      />
