...
export const Route = createFileRoute("/services/canada/mdsap-canada-and-iso-13485-quality-system-readiness")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/mdsap-canada-and-iso-13485-quality-system-readiness" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/mdsap-canada-and-iso-13485-quality-system-readiness" }],
    scripts: [
      {
