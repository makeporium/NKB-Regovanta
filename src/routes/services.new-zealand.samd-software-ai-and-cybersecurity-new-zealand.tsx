...
export const Route = createFileRoute("/services/new-zealand/samd-software-ai-and-cybersecurity-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/samd-software-ai-and-cybersecurity-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/samd-software-ai-and-cybersecurity-new-zealand" }],
    scripts: [
      {
