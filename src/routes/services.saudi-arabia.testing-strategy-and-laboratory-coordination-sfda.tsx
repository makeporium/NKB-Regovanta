...
export const Route = createFileRoute("/services/saudi-arabia/testing-strategy-and-laboratory-coordination-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/testing-strategy-and-laboratory-coordination-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/testing-strategy-and-laboratory-coordination-sfda" }],
        scripts: [
      {
