...
export const Route = createFileRoute("/services/new-zealand/testing-strategy-and-laboratory-coordination-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/testing-strategy-and-laboratory-coordination-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/testing-strategy-and-laboratory-coordination-new-zealand" }],
    scripts: [
      {
