...
export const Route = createFileRoute("/services/saudi-arabia/sfda-queries-deficiency-response-and-technical-review-support")({
  head: () => ({
    meta: [
      { name: "robots", content: "index, follow, max-image-preview:large" },
      {
        title: "SFDA Queries & Deficiency Response | NKB Regovanta",
      },
      {
        name: "description",
        content:
          "SFDA technical query responses, MDMA deficiency letters, and scientific rebuttals in Saudi Arabia. Dossier revisions and time-bound GHAD portal closure.",
      },
      { property: "og:title", content: "SFDA Queries & Deficiency Response | NKB Regovanta" },
      {
        property: "og:description",
        content:
          "SFDA technical query responses, MDMA deficiency letters, and scientific rebuttals in Saudi Arabia. Dossier revisions and time-bound GHAD portal closure.",
      },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/sfda-queries-deficiency-response-and-technical-review-support" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SFDA Queries & Deficiency Response | NKB Regovanta" },
      {
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/sfda-queries-deficiency-response-and-technical-review-support" }],
        scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "SFDA Query and Deficiency Response (Saudi Arabia)",
          areaServed: { "@type": "Country", name: "Saudi Arabia" },
          description: "SFDA query and deficiency response consulting for medical device registrations in Saudi Arabia - technical response formulation, root-cause analysis, and CAPA packages.",
