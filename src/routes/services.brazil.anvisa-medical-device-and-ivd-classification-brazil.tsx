...
export const Route = createFileRoute("/services/brazil/anvisa-medical-device-and-ivd-classification-brazil")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-medical-device-and-ivd-classification-brazil" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-medical-device-and-ivd-classification-brazil" }],
    scripts: [
      {
