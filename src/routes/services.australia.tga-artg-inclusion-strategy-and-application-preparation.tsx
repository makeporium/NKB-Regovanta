...
export const Route = createFileRoute("/services/australia/tga-artg-inclusion-strategy-and-application-preparation")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-artg-inclusion-strategy-and-application-preparation" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-artg-inclusion-strategy-and-application-preparation" }],
    scripts: [
      {
