...
export const Route = createFileRoute('/services/brazil/brh')({
  head: () => ({
    meta: [
      { title: 'Brazilian Registration Holder (BRH) | Brazil Services | NKB Regovanta' },
      { name: 'description', content: 'Explore our specialized Brazil Brazilian Registration Holder (BRH) services for medical devices and IVDs.' },
    ],
  links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/brh" },
  ],
  }),
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">Brazilian Registration Holder (BRH)</h1>
            <p className="text-lg text-white/80 leading-relaxed">
              Navigate the complexities of the Brazil regulatory landscape with our comprehensive Brazilian Registration Holder (BRH) support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The regulatory authority in Brazil maintains strict requirements for Brazilian Registration Holder (BRH). Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the Brazil market.
              </p>
