...
export const Route = createFileRoute("/case-studies/avoiding-duplicate-simulated-use-work-by-leveraging-an-already-marketed-safety-feature")({
  head: () => ({
    meta: [
      { title: "FDA Simulated-Use Testing Case Study | NKB Regovanta" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "FDA Simulated-Use Testing Case Study | NKB Regovanta" },
      {
        property: "og:description",
        content:
          "Case study: How NKB Regovanta designed a unified FDA 510(k) simulated-use study covering three equivalence arguments to cut client testing time in half.",
      },
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/avoiding-duplicate-simulated-use-work-by-leveraging-an-already-marketed-safety-feature" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/avoiding-duplicate-simulated-use-work-by-leveraging-an-already-marketed-safety-feature" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Article",
          headline: "FDA Simulated-Use Testing Case Study",
          description:
            "Case study: How NKB Regovanta designed a unified FDA 510(k) simulated-use study covering three equivalence arguments to cut client testing time in half.",
          publisher: {
            "@type": "Organization",
