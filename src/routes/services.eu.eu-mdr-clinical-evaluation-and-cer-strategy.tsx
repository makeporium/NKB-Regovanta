...
export const Route = createFileRoute("/services/eu/eu-mdr-clinical-evaluation-and-cer-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-clinical-evaluation-and-cer-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-clinical-evaluation-and-cer-strategy" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-clinical-evaluation-and-cer-strategy",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Clinical Evaluation", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-clinical-evaluation-and-cer-strategy" },
              ],
            },
          ]),
        }}
