...
export const Route = createFileRoute("/services/eu/post-market-clinical-follow-up-pmcf-strategy-and-execution")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/post-market-clinical-follow-up-pmcf-strategy-and-execution" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/post-market-clinical-follow-up-pmcf-strategy-and-execution" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/post-market-clinical-follow-up-pmcf-strategy-and-execution",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "PMS & PMCF", item: "https://www.nkbregovanta.com/services/eu/post-market-clinical-follow-up-pmcf-strategy-and-execution" },
              ],
            },
          ]),
        }}
