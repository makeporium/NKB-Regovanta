...
export const Route = createFileRoute('/services/uk/pms')({
  head: () => ({
    meta: [
      { title: 'Post-Market Surveillance (PMS) | UK Services | NKB Regovanta' },
      { name: 'description', content: 'Explore our specialized UK Post-Market Surveillance (PMS) services for medical devices and IVDs.' },
    ],
  links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/pms" },
  ],
  }),
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/80 leading-relaxed">
              Navigate the complexities of the UK regulatory landscape with our comprehensive Post-Market Surveillance (PMS) support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The United Kingdom maintains strict requirements for Post-Market Surveillance (PMS) under the MHRA frameworks. Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the UK market.
              </p>
