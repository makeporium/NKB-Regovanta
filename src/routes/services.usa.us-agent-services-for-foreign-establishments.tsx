...
export const Route = createFileRoute("/services/usa/us-agent-services-for-foreign-establishments")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/us-agent-services-for-foreign-establishments" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/us-agent-services-for-foreign-establishments" },
    ],
    scripts: [
      {
