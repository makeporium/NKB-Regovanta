...
export const Route = createFileRoute('/services/australia/tga-post-market-surveillance-pms-plans')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-post-market-surveillance-pms-plans" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-post-market-surveillance-pms-plans" },
    ],
    scripts: [
      {
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4">TGA Post-Market Surveillance (PMS) Plans</h1>
