...
export const Route = createFileRoute('/services/canada/health-canada-regulatory-liaison-support')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-regulatory-liaison-support" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-regulatory-liaison-support" },
    ],
    scripts: [
      {
