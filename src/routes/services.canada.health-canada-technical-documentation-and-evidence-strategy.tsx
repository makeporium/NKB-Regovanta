...
export const Route = createFileRoute("/services/canada/health-canada-technical-documentation-and-evidence-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-technical-documentation-and-evidence-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-technical-documentation-and-evidence-strategy" }],
    scripts: [
      {
