...
export const Route = createFileRoute("/services/australia/tga-ivd-regulatory-strategy-and-artg-inclusion")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-ivd-regulatory-strategy-and-artg-inclusion" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-ivd-regulatory-strategy-and-artg-inclusion" }],
    scripts: [
      {
