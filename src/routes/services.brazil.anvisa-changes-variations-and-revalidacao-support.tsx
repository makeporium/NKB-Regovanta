...
export const Route = createFileRoute("/services/brazil/anvisa-changes-variations-and-revalidacao-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-changes-variations-and-revalidacao-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-changes-variations-and-revalidacao-support" }],
    scripts: [
      {
