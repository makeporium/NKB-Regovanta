...
export const Route = createFileRoute("/services/brazil/brazil-registration-holder-brh-and-anvisa-interface")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/brazil-registration-holder-brh-and-anvisa-interface" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/brazil-registration-holder-brh-and-anvisa-interface" }],
    scripts: [
      {
