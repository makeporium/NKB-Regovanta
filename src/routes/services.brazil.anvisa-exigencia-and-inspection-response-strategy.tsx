...
export const Route = createFileRoute("/services/brazil/anvisa-exigencia-and-inspection-response-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-exigencia-and-inspection-response-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-exigencia-and-inspection-response-strategy" }],
    scripts: [
      {
