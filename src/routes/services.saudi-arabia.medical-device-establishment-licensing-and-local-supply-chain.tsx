...
export const Route = createFileRoute("/services/saudi-arabia/medical-device-establishment-licensing-and-local-supply-chain")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/medical-device-establishment-licensing-and-local-supply-chain" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/medical-device-establishment-licensing-and-local-supply-chain" }],
        scripts: [
      {
