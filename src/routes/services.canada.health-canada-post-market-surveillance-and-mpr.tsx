...
export const Route = createFileRoute("/services/canada/health-canada-post-market-surveillance-and-mpr")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-post-market-surveillance-and-mpr" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-post-market-surveillance-and-mpr" }],
    scripts: [
      {
