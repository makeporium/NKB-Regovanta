...
export const Route = createFileRoute("/services/india/import-authorization-for-novel-ivds-md-26-and-md-27")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/import-authorization-for-novel-ivds-md-26-and-md-27" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/import-authorization-for-novel-ivds-md-26-and-md-27" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Import Authorization for  Novel IVDs (MD-26 & MD-27)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Import Authorization for  Novel IVDs (MD-26 & MD-27)" className="mt-8 w-full" />
        </div>
      </section>
