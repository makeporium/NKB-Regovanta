...
export const Route = createFileRoute("/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "CDSCO MD-7 & MD-9 manufacturing license consulting for Class C & D medical devices in India. Plant audit readiness, technical files, and CLA support." },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Class C & D Manufacturing License (MD-9) | NKB Regovanta" },
      { name: "twitter:description", content: "CDSCO MD-7 & MD-9 manufacturing license consulting for Class C & D medical devices in India. Plant audit readiness, technical files, and CLA support." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "Class C & D Medical Device Manufacturing License (MD-7 & MD-9)",
          description: "CDSCO MD-7 and MD-9 manufacturing licenses for high-risk Class C and D medical devices in India.",
          provider: {
            "@type": "Organization",
            name: "NKB Regovanta",
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Class C & D Manufacturing  (Forms MD-7 & MD-9)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Class C & D Manufacturing  (Forms MD-7 & MD-9)" className="mt-8 w-full" />
        </div>
      </section>
              ...
              <div className="bg-navy rounded-2xl p-8 border border-gray-100 sticky top-24 text-white">
                ...
                <div className="mt-8 pt-8 border-t border-white/20">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link to="/services/india/loan-licenses-for-class-c-and-d-forms-md-8-and-md-10" className="text-sm text-gold hover:underline flex items-start gap-2">
