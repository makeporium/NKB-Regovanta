...
export const Route = createFileRoute("/services/uae/uae-local-applicant-marketing-authorization-holder-and-regulatory-interface")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/uae-local-applicant-marketing-authorization-holder-and-regulatory-interface" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/uae-local-applicant-marketing-authorization-holder-and-regulatory-interface" }],
        scripts: [
      {
