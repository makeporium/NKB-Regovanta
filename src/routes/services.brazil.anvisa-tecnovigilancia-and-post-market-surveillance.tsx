...
export const Route = createFileRoute("/services/brazil/anvisa-tecnovigilancia-and-post-market-surveillance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-tecnovigilancia-and-post-market-surveillance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-tecnovigilancia-and-post-market-surveillance" }],
    scripts: [
      {
