...
export const Route = createFileRoute("/services/eu/eu-mdr-software-and-samd-regulatory-consulting")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-software-and-samd-regulatory-consulting" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-software-and-samd-regulatory-consulting" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-software-and-samd-regulatory-consulting",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Software & SaMD", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-software-and-samd-regulatory-consulting" },
              ],
            },
          ]),
        }}
