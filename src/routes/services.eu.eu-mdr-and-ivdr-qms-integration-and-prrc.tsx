...
export const Route = createFileRoute("/services/eu/eu-mdr-and-ivdr-qms-integration-and-prrc")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qms-integration-and-prrc" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qms-integration-and-prrc" }],
  }),
  component: EUQMSPage,
});
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qms-integration-and-prrc",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "QMS & PRRC", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qms-integration-and-prrc" },
              ],
            },
          ]),
        }}
