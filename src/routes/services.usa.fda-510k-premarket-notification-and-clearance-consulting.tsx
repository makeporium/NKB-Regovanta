...
export const Route = createFileRoute("/services/usa/fda-510k-premarket-notification-and-clearance-consulting")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-510k-premarket-notification-and-clearance-consulting" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-510k-premarket-notification-and-clearance-consulting" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/fda-510k-premarket-notification-and-clearance-consulting",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "510(k) / 510 k Consultant", item: "https://www.nkbregovanta.com/services/usa/fda-510k-premarket-notification-and-clearance-consulting" },
              ],
            },
          ]),
        }}
