...
export const Route = createFileRoute("/services/eu/eu-mdr-and-ivdr-qualification-and-classification")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qualification-and-classification" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qualification-and-classification" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qualification-and-classification",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Classification", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-qualification-and-classification" },
              ],
            },
          ]),
        }}
