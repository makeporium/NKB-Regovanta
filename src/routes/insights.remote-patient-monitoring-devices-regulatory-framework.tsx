...
export const Route = createFileRoute("/insights/remote-patient-monitoring-devices-regulatory-framework")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/connected_patient_care.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/connected_patient_care.jpg" }
    ],
