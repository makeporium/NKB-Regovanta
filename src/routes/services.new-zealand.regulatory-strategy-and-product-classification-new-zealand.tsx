...
export const Route = createFileRoute("/services/new-zealand/regulatory-strategy-and-product-classification-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/regulatory-strategy-and-product-classification-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/regulatory-strategy-and-product-classification-new-zealand" }],
    scripts: [
      {
