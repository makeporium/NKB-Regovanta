...
export const Route = createFileRoute("/insights/regulatory-compliance-strategy-global-medtech")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/global_map_logistics.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/global_map_logistics.jpg" }
    ],
