...
export const Route = createFileRoute("/services/uk/ukca-labeling-and-artwork-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/ukca-labeling-and-artwork-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/ukca-labeling-and-artwork-compliance" }],
    scripts: [
      {
