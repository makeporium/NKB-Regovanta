...
export const Route = createFileRoute('/services/eu/qms')({
  head: () => ({
    meta: [
      { title: 'QMS Implementation Support | EU Services | NKB Regovanta' },
      { name: 'description', content: 'Explore our specialized EU QMS Implementation Support services for medical devices and IVDs.' },
    ],
  links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/qms" },
  ],
  }),
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg text-white/80 leading-relaxed">
              Navigate the complexities of the European regulatory landscape with our comprehensive QMS Implementation Support support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The European Union maintains strict requirements for QMS Implementation Support under the MDR and IVDR frameworks. Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the European market.
              </p>
