...
export const Route = createFileRoute("/services/uae/mohap-medical-device-registration-and-dossier-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/mohap-medical-device-registration-and-dossier-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/mohap-medical-device-registration-and-dossier-strategy" }],
        scripts: [
      {
