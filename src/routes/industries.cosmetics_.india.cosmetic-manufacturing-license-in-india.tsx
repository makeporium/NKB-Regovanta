...
export const Route = createFileRoute("/industries/cosmetics_/india/cosmetic-manufacturing-license-in-india")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/industries/cosmetics/india/cosmetic-manufacturing-license-in-india" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/industries/cosmetics/india/cosmetic-manufacturing-license-in-india" },
    ],
    scripts: [
      {
