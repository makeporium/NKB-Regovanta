    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img src={heroImg} alt="Personal Use Import License  (Forms MD-20, MD-21)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img src={heroImg} alt="Personal Use Import License  (Forms MD-20, MD-21)" className="mt-8 w-full" />
        </div>
      </section>
