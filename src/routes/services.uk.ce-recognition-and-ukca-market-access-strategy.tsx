...
export const Route = createFileRoute("/services/uk/ce-recognition-and-ukca-market-access-strategy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Strategic consulting on CE recognition in Great Britain up to 2030, UKCA marking pathways, UK Approved Body selection, and Northern Ireland strategy.",
      },
      { property: "og:title", content: "UKCA Marking & CE Recognition Strategy | NKB Regovanta" },
      {
        property: "og:description",
        content: "Strategic consulting on CE recognition in Great Britain up to 2030, UKCA marking pathways, UK Approved Body selection, and Northern Ireland strategy.",
      },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/ce-recognition-and-ukca-market-access-strategy" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "UKCA Marking & CE Recognition Strategy | NKB Regovanta" },
      { name: "twitter:description", content: "Strategic consulting on CE recognition in Great Britain up to 2030, UKCA marking pathways, UK Approved Body selection, and Northern Ireland strategy." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/ce-recognition-and-ukca-market-access-strategy" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/uk/ce-recognition-and-ukca-market-access-strategy",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "CE Recognition & UKCA", item: "https://www.nkbregovanta.com/services/uk/ce-recognition-and-ukca-market-access-strategy" },
              ],
            },
          ]),
        }}
