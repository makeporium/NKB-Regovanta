...
export const Route = createFileRoute("/services/canada/health-canada-mdl-amendments-and-significant-changes")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-mdl-amendments-and-significant-changes" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-mdl-amendments-and-significant-changes" }],
    scripts: [
      {
