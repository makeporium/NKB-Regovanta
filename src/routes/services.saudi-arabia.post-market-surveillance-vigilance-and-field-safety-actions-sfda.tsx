...
export const Route = createFileRoute("/services/saudi-arabia/post-market-surveillance-vigilance-and-field-safety-actions-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/post-market-surveillance-vigilance-and-field-safety-actions-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/post-market-surveillance-vigilance-and-field-safety-actions-sfda" }],
        scripts: [
      {
