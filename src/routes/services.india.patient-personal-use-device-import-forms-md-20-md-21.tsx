...
export const Route = createFileRoute("/services/india/patient-personal-use-device-import-forms-md-20-md-21")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/patient-personal-use-device-import-forms-md-20-md-21" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/patient-personal-use-device-import-forms-md-20-md-21" },
    ],
    scripts: [
      {
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="mb-6 rounded-xl border border-amber-200 bg-amber-50 px-5 py-4 text-sm leading-relaxed text-gray-700">
                  ...
                  <Link to="/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india" className="font-bold text-[#0b3a96] underline underline-offset-2">
