...
export const Route = createFileRoute('/services/brazil/anvisa-technovigilance-services-brazil')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-technovigilance-services-brazil" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-technovigilance-services-brazil" }],
    scripts: [
      {
