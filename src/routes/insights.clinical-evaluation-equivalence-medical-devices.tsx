...
export const Route = createFileRoute("/insights/clinical-evaluation-equivalence-medical-devices")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/clinical_evaluation_doctor.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/clinical_evaluation_doctor.jpg" }
    ],
