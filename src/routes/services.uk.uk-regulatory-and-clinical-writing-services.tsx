...
export const Route = createFileRoute("/services/uk/uk-regulatory-and-clinical-writing-services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/uk-regulatory-and-clinical-writing-services" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/uk-regulatory-and-clinical-writing-services" }],
    scripts: [
      {
