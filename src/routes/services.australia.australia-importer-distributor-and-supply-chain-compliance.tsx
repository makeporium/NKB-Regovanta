...
export const Route = createFileRoute("/services/australia/australia-importer-distributor-and-supply-chain-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/australia-importer-distributor-and-supply-chain-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/australia-importer-distributor-and-supply-chain-compliance" }],
    scripts: [
      {
