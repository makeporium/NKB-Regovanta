...
export const Route = createFileRoute("/services/eu/eudamed-udi-and-economic-operator-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eudamed-udi-and-economic-operator-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eudamed-udi-and-economic-operator-compliance" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eudamed-udi-and-economic-operator-compliance",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "EUDAMED & UDI", item: "https://www.nkbregovanta.com/services/eu/eudamed-udi-and-economic-operator-compliance" },
              ],
            },
          ]),
        }}
