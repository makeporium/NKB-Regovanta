...
export const Route = createFileRoute("/services/new-zealand/labelling-ifu-and-advertising-compliance-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/labelling-ifu-and-advertising-compliance-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/labelling-ifu-and-advertising-compliance-new-zealand" }],
    scripts: [
      {
