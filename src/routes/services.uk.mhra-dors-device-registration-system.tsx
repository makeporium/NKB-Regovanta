...
export const Route = createFileRoute("/services/uk/mhra-dors-device-registration-system")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/mhra-dors-device-registration-system" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/mhra-dors-device-registration-system" }],
    scripts: [
      {
