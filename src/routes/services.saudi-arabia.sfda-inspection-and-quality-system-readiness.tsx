...
export const Route = createFileRoute("/services/saudi-arabia/sfda-inspection-and-quality-system-readiness")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/sfda-inspection-and-quality-system-readiness" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/sfda-inspection-and-quality-system-readiness" }],
        scripts: [
      {
