...
export const Route = createFileRoute('/services/australia/tga-conformity-assessment-support')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-conformity-assessment-support" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-conformity-assessment-support" },
    ],
    scripts: [
      {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The regulatory authority in Australia maintains strict requirements for Conformity Assessment Support. Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the Australia market.
              </p>
