...
const classificationData = [
    ...
    { classLabel: "Class II", risk: "Moderate Risk (with predicate)", pathway: "Premarket Notification / 510(k)" },
    { classLabel: "Class II", risk: "Moderate Risk (no predicate)", pathway: "De-Novo Classification Request" },
    { classLabel: "Class III", risk: "High Risk", pathway: "Premarket Approval (PMA)" },
];

const summaryData = [
    { risk: "Low Risk", cls: "I", audit: "No", predicate: "N/A", pathway: "Exempt", agent: "Yes", timeline: "~1 Month" },
    { risk: "Medium Risk", cls: "II", audit: "Yes (post-approval)", predicate: "Yes", pathway: "510(k) PMN", agent: "Yes", timeline: "9-12 Months" },
    { risk: "Medium Risk", cls: "II", audit: "Yes (post-approval)", predicate: "No", pathway: "De-Novo", agent: "Yes", timeline: "18-30 Months" },
    { risk: "High Risk", cls: "III", audit: "Yes (pre-approval)", predicate: "N/A", pathway: "PMA", agent: "Yes", timeline: "18-30 Months" },
];
...
const regulatoryDetails = [
    ...
    { label: "Registration Pathway", value: "Premarket Notification (510k), Premarket Approval (PMA), or De-Novo Classification" },
    { label: "Authorized Representative", value: "U.S. FDA Agent" },
    ...
    { label: "Submission Format", value: "eSTAR" },
...
const lifecycleItems = [
    {
        ...
        desc: "Modifications to an approved medical device — whether they relate to design, materials, manufacturing processes, software, indications for use, or labeling — must be carefully evaluated against FDA change control requirements. Depending on the nature and significance of the change, a new 510(k), PMA supplement, or a simple records update may be required. NKB Regovanta helps manufacturers assess, document, and file changes efficiently to minimize disruption to ongoing commercialization."
    },
    {
                ...
                {activeTab === "Overview" && (
                    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-2 duration-500">
                        ...
                        <div className="space-y-6 text-[13.5px] text-navy/80 leading-relaxed">
                            <div>
                                <h3 className="text-base font-bold text-navy mb-2">U.S. FDA Agent Requirement</h3>
                            ...
                            <div>
                                <h3 className="text-base font-bold text-navy mb-2">Interactive Pre-Submission Meetings with the FDA</h3>
