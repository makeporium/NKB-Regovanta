...
export const Route = createFileRoute("/insights/biological-evaluation-testing-medical-devices-iso-10993")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/petri_dish_biocompatibility.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/petri_dish_biocompatibility.jpg" }
    ],
