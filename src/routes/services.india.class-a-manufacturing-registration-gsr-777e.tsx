...
export const Route = createFileRoute("/services/india/class-a-manufacturing-registration-gsr-777e")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/class-a-manufacturing-registration-gsr-777e" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/class-a-manufacturing-registration-gsr-777e" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Class A Manufacturing  Registration (GSR 777(E))" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Class A Manufacturing  Registration (GSR 777(E))" className="mt-8 w-full" />
        </div>
      </section>
