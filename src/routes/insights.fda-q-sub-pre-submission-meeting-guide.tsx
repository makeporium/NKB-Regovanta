...
export const Route = createFileRoute("/insights/fda-q-sub-pre-submission-meeting-guide")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/executive_meeting_handshake.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/executive_meeting_handshake.jpg" }
    ],
