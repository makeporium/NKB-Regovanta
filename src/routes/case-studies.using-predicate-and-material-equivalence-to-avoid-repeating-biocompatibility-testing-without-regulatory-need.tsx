...
export const Route = createFileRoute("/case-studies/using-predicate-and-material-equivalence-to-avoid-repeating-biocompatibility-testing-without-regulatory-need")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/using-predicate-and-material-equivalence-to-avoid-repeating-biocompatibility-testing-without-regulatory-need" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/using-predicate-and-material-equivalence-to-avoid-repeating-biocompatibility-testing-without-regulatory-need" },
    ],
    scripts: [
      {
...
function Article() {
  return (
    <>
      ...
      <CTABand title="Looking for a smarter evaluation strategy?" description="NKB Regovanta can help." action="Contact Us Today" />
    </>
  );
}
