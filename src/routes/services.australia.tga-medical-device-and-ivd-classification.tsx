...
export const Route = createFileRoute("/services/australia/tga-medical-device-and-ivd-classification")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-medical-device-and-ivd-classification" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-medical-device-and-ivd-classification" }],
    scripts: [
      {
