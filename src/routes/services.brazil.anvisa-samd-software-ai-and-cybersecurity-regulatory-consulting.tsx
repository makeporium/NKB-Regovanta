...
export const Route = createFileRoute("/services/brazil/anvisa-samd-software-ai-and-cybersecurity-regulatory-consulting")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-samd-software-ai-and-cybersecurity-regulatory-consulting" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-samd-software-ai-and-cybersecurity-regulatory-consulting" }],
    scripts: [
      {
