...
export const Route = createFileRoute("/services/new-zealand/importer-distributor-and-supply-chain-compliance-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/importer-distributor-and-supply-chain-compliance-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/importer-distributor-and-supply-chain-compliance-new-zealand" }],
    scripts: [
      {
