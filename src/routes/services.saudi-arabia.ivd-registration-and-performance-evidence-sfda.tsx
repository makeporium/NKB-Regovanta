...
export const Route = createFileRoute("/services/saudi-arabia/ivd-registration-and-performance-evidence-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/ivd-registration-and-performance-evidence-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/ivd-registration-and-performance-evidence-sfda" }],
        scripts: [
      {
