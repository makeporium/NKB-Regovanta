...
const summaryData = [
    { risk: "Low", cls: "I", qms: "N/A", pathway: "MDEL", docs: "MDEL application, QMS procedures", timeline: "N/A" },
    { risk: "Low-Mod", cls: "II", qms: "MDSAP Certificate", pathway: "MDL", docs: "MDL application, Fee form, Labeling, DoC, MDSAP cert", timeline: "15 Days" },
    { risk: "High-Mod", cls: "III", qms: "MDSAP Certificate", pathway: "MDL", docs: "MDL application, DoC, ISO 13485 (MDSAP), Labeling, IMDRF Tech File", timeline: "60 Days" },
    { risk: "High", cls: "IV", qms: "MDSAP Certificate", pathway: "MDL", docs: "MDL application, DoC, ISO 13485 (MDSAP), Labeling, IMDRF Tech File", timeline: "75 Days" },
];

const lifecycleItems = [
    { title: "Post-Approval Change Management", desc: "We expertly manage modifications to existing approvals, navigating the regulatory requirements for adding new variants, introducing accessories, or updating indications for use without disrupting your market access." },
    { title: "License Maintenance & Renewals", desc: "Maintaining compliance requires strict adherence to Health Canada’s administrative timelines. We ensure the timely payment of all registration fees and manage the annual license renewal process on your behalf." },
    { title: "Health Canada Liaison Support", desc: "NKB Regovanta acts as the vital communication bridge between your organization and Health Canada, responding to regulatory queries, clarification requests, and ensuring continuous alignment with agency expectations." }
];
