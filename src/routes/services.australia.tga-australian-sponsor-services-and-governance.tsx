...
export const Route = createFileRoute("/services/australia/tga-australian-sponsor-services-and-governance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-australian-sponsor-services-and-governance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-australian-sponsor-services-and-governance" }],
    scripts: [
      {
