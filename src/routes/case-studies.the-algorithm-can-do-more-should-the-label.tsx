...
export const Route = createFileRoute("/case-studies/the-algorithm-can-do-more-should-the-label")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/the-algorithm-can-do-more-should-the-label" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/the-algorithm-can-do-more-should-the-label" },
    ],
    scripts: [
      {
