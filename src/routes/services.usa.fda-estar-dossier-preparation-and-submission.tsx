...
export const Route = createFileRoute("/services/usa/fda-estar-dossier-preparation-and-submission")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-estar-dossier-preparation-and-submission" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-estar-dossier-preparation-and-submission" }],
  }),
  component: EStarPage,
});
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/fda-estar-dossier-preparation-and-submission",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "eSTAR Dossier", item: "https://www.nkbregovanta.com/services/usa/fda-estar-dossier-preparation-and-submission" },
              ],
            },
          ]),
        }}
