...
export const Route = createFileRoute("/services/uae/samd-software-ai-and-cybersecurity-uae-mohap")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/samd-software-ai-and-cybersecurity-uae-mohap" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/samd-software-ai-and-cybersecurity-uae-mohap" }],
        scripts: [
      {
