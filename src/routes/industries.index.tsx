        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5 items-center text-center">
             <div className="flex flex-col items-center">
                ...
                <div className="mt-1 text-xs uppercase tracking-wide text-navy-foreground/70">Industries Supported</div>
             </div>
             <div className="flex flex-col items-center">
                <div className="text-2xl font-extrabold">30+</div>
                <div className="mt-1 text-xs uppercase tracking-wide text-navy-foreground/70">Countries Covered</div>
             </div>
             <div className="flex flex-col items-center">
                <div className="text-2xl font-extrabold">15+</div>
                <div className="mt-1 text-xs uppercase tracking-wide text-navy-foreground/70">Years of Industry Experience</div>
             </div>
             <div className="flex flex-col items-center">
                <div className="text-2xl font-extrabold">100%</div>
                <div className="mt-1 text-xs uppercase tracking-wide text-navy-foreground/70">Compliance Focus</div>
             </div>
