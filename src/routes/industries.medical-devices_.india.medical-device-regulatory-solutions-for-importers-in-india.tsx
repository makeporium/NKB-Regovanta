...
export const Route = createFileRoute("/industries/medical-devices_/india/medical-device-regulatory-solutions-for-importers-in-india")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india" },
    ],
    scripts: [
      {
