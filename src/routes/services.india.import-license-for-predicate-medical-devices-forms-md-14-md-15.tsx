...
export const Route = createFileRoute("/services/india/import-license-for-predicate-medical-devices-forms-md-14-md-15")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/import-license-for-predicate-medical-devices-forms-md-14-md-15" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/import-license-for-predicate-medical-devices-forms-md-14-md-15" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Import License for Predicate Medical Devices  (Forms MD-14, MD-15)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Import License for Predicate Medical Devices  (Forms MD-14, MD-15)" className="mt-8 w-full" />
        </div>
      </section>
