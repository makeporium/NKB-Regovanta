...
export const Route = createFileRoute("/insights/ce-marking-digital-health-technologies")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/software_medical_screen.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/software_medical_screen.jpg" }
    ],
