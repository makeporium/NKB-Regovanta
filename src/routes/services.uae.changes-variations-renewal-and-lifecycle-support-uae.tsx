...
export const Route = createFileRoute("/services/uae/changes-variations-renewal-and-lifecycle-support-uae")({
  head: () => ({
    meta: [
      { name: "robots", content: "noindex, follow" },
      {
        title: "MOHAP Changes & Renewals (UAE) | NKB Regovanta",
      },
      {
        name: "description",
        content:
          "MOHAP variation notifications and medical device renewals in UAE. Design changes, site transfers, renewals, and technical file updates.",
      },
      { property: "og:title", content: "MOHAP Changes & Renewals (UAE) | NKB Regovanta" },
      {
        property: "og:description",
        content:
          "MOHAP variation notifications and medical device renewals in UAE. Design changes, site transfers, renewals, and technical file updates.",
      },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/changes-variations-renewal-and-lifecycle-support-uae" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "MOHAP Changes & Renewals (UAE) | NKB Regovanta" },
      {
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/changes-variations-renewal-and-lifecycle-support-uae" }],
        scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "MOHAP Medical Device Change Management (UAE)",
          areaServed: { "@type": "Country", name: "United Arab Emirates" },
          description: "MOHAP post-registration change management for medical devices in the UAE - significant and non-significant changes, resubmission, and MOHAP change notifications.",
