...
export const Route = createFileRoute("/services/canada/canada-medical-device-supply-chain-and-importer-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/canada-medical-device-supply-chain-and-importer-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/canada-medical-device-supply-chain-and-importer-compliance" }],
    scripts: [
      {
