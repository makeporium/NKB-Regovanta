...
export const Route = createFileRoute("/services/canada/health-canada-medical-device-licence-mdl-application")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-licence-mdl-application" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-licence-mdl-application" }],
    scripts: [
      {
