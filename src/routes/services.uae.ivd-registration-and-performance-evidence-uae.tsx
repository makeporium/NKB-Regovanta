...
export const Route = createFileRoute("/services/uae/ivd-registration-and-performance-evidence-uae")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/ivd-registration-and-performance-evidence-uae" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/ivd-registration-and-performance-evidence-uae" }],
        scripts: [
      {
