...
export const Route = createFileRoute("/services/saudi-arabia/labeling-ifu-udi-and-advertising-compliance-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/labeling-ifu-udi-and-advertising-compliance-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/labeling-ifu-udi-and-advertising-compliance-sfda" }],
        scripts: [
      {
