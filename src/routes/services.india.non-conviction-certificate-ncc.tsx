...
export const Route = createFileRoute("/services/india/non-conviction-certificate-ncc")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/non-conviction-certificate-ncc" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/non-conviction-certificate-ncc" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Non-Conviction Certificate  (NCC)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Non-Conviction Certificate  (NCC)" className="mt-8 w-full" />
        </div>
      </section>
            ...
            <div className="lg:col-span-1">
              <div className="bg-navy rounded-2xl p-8 border border-gray-100 sticky top-24 text-white">
                ...
                <div className="mt-8 pt-8 border-t border-white/20">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link to="/services/india/market-standing-certificate-msc" className="text-sm text-gold hover:underline flex items-start gap-2">
