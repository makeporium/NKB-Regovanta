...
export const Route = createFileRoute("/services/usa/us-fda-de-novo-classification-pathway")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/us-fda-de-novo-classification-pathway" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/us-fda-de-novo-classification-pathway" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/us-fda-de-novo-classification-pathway",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "De Novo Classification", item: "https://www.nkbregovanta.com/services/usa/us-fda-de-novo-classification-pathway" },
              ],
            },
          ]),
        }}
