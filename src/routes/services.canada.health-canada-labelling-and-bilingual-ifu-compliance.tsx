...
export const Route = createFileRoute("/services/canada/health-canada-labelling-and-bilingual-ifu-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-labelling-and-bilingual-ifu-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-labelling-and-bilingual-ifu-compliance" }],
    scripts: [
      {
