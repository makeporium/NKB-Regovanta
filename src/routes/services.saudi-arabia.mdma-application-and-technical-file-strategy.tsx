...
export const Route = createFileRoute("/services/saudi-arabia/mdma-application-and-technical-file-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/mdma-application-and-technical-file-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/mdma-application-and-technical-file-strategy" }],
        scripts: [
      {
