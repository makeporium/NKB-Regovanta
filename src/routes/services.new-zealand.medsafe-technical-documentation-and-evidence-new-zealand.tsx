...
export const Route = createFileRoute("/services/new-zealand/medsafe-technical-documentation-and-evidence-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/medsafe-technical-documentation-and-evidence-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/medsafe-technical-documentation-and-evidence-new-zealand" }],
    scripts: [
      {
