...
export const Route = createFileRoute("/services/new-zealand/change-notification-and-lifecycle-support-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/change-notification-and-lifecycle-support-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/change-notification-and-lifecycle-support-new-zealand" }],
    scripts: [
      {
