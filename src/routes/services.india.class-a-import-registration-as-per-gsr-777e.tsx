...
export const Route = createFileRoute("/services/india/class-a-import-registration-as-per-gsr-777e")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Expert CDSCO consulting for Class A medical device import under GSR 777(E). Fast-track registration for non-sterile and non-measuring devices in India." },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/class-a-import-registration-as-per-gsr-777e" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Class A Import Registration (GSR 777(E)) | NKB Regovanta" },
      { name: "twitter:description", content: "Expert CDSCO consulting for Class A medical device import under GSR 777(E). Fast-track registration for non-sterile and non-measuring devices in India." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/class-a-import-registration-as-per-gsr-777e" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "Class A Import Registration (GSR 777(E))",
          description: "Expert CDSCO consulting for Class A medical device import registration under GSR 777(E) in India.",
          provider: {
            "@type": "Organization",
            name: "NKB Regovanta",
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Class A Import Registration  as per GSR 777(E)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Class A Import Registration  as per GSR 777(E)" className="mt-8 w-full" />
        </div>
      </section>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 sticky top-24">
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link to="/services/india/class-a-manufacturing-registration-gsr-777e" className="text-sm text-blue-600 hover:underline flex items-start gap-2">
                        <FileText className="h-4 w-4 shrink-0 mt-0.5" />
                        Manufacturing Registration (GSR 777(E))
                      </Link>
                    </li>
                    <li>
                      <Link to="/services/india/md-42-medical-device-registration-certificate" className="text-sm text-blue-600 hover:underline flex items-start gap-2">
                        <FileText className="h-4 w-4 shrink-0 mt-0.5" />
                        MD-42 Certificate
                      </Link>
                    </li>
