...
export const Route = createFileRoute("/industries/cosmetics_/india/cosmetics-registration-for-importers-in-india")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Import cosmetics into India with CDSCO Form COS-1 and COS-2 registration. Expert support for SUGAM portal filings, wholesale licenses, and compliance." },
      { property: "og:url", content: "https://www.nkbregovanta.com/industries/cosmetics/india/cosmetics-registration-for-importers-in-india" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cosmetics Import Registration India | NKB Regovanta" },
      { name: "twitter:description", content: "Import cosmetics into India with CDSCO Form COS-1 and COS-2 registration. Expert support for SUGAM portal filings, wholesale licenses, and compliance." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/industries/cosmetics/india/cosmetics-registration-for-importers-in-india" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          "name": "Cosmetics Registration for Importers in India",
          "provider": {
            "@type": "Organization",
            "name": "NKB Regovanta",
            "url": "https://www.nkbregovanta.com"
          },
          "description": "Import cosmetics into India with CDSCO Form COS-1 and COS-2 registration. Expert support for SUGAM portal filings, wholesale licenses, and compliance.",
          "serviceType": "Cosmetics Import Registration"
        })
      }
    ],
  }),
