...
export const Route = createFileRoute("/services/australia/tga-clinical-evidence-and-benefit-risk-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-clinical-evidence-and-benefit-risk-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-clinical-evidence-and-benefit-risk-strategy" }],
    scripts: [
      {
