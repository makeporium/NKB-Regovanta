...
export const Route = createFileRoute("/services/australia/australia-tga-samd-ai-and-cybersecurity-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/australia-tga-samd-ai-and-cybersecurity-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/australia-tga-samd-ai-and-cybersecurity-support" }],
    scripts: [
      {
