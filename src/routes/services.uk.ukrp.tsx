...
export const Route = createFileRoute('/services/uk/ukrp')({
  head: () => ({
    meta: [
      { title: 'UK Responsible Person (UKRP) | UK Services | NKB Regovanta' },
      { name: 'description', content: 'Explore our specialized UK UK Responsible Person (UKRP) services for medical devices and IVDs.' },
    ],
  }),
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">UK Responsible Person (UKRP)</h1>
            <p className="text-lg text-white/80 leading-relaxed">
              Navigate the complexities of the UK regulatory landscape with our comprehensive UK Responsible Person (UKRP) support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The United Kingdom maintains strict requirements for UK Responsible Person (UKRP) under the MHRA frameworks. Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the UK market.
              </p>
