...
export const Route = createFileRoute("/services/new-zealand/medsafe-queries-safety-review-and-technical-response")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/medsafe-queries-safety-review-and-technical-response" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/medsafe-queries-safety-review-and-technical-response" }],
    scripts: [
      {
