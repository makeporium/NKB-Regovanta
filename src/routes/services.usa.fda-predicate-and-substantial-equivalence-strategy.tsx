...
export const Route = createFileRoute("/services/usa/fda-predicate-and-substantial-equivalence-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-predicate-and-substantial-equivalence-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-predicate-and-substantial-equivalence-strategy" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/fda-predicate-and-substantial-equivalence-strategy",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Predicate Strategy", item: "https://www.nkbregovanta.com/services/usa/fda-predicate-and-substantial-equivalence-strategy" },
              ],
            },
          ]),
        }}
