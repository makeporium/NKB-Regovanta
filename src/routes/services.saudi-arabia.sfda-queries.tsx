...
export const Route = createFileRoute("/services/saudi-arabia/sfda-queries")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "SFDA Queries, Deficiency Response & Technical Review Support, services saudi arabia sfda queries, NKB Regovanta, regulatory consultant, medical device" },
      { property: "og:title", content: "SFDA Queries, Deficiency Response & Technical Review Support | NKB Regovanta" },
      { property: "og:description", content: "Strategic response formulation for SFDA technical queries, MDMA deficiency letters, and scientific rebuttals in Saudi Arabia. Root-cause analysis, dossier revisions, and time-bound closure." },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/sfda-queries" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "SFDA Queries, Deficiency Response & Technical Review Support | NKB Regovanta" },
      { name: "twitter:description", content: "Strategic response formulation for SFDA technical queries, MDMA deficiency letters, and scientific rebuttals in Saudi Arabia. Root-cause analysis, dossier revisions, and time-bound closure." },
