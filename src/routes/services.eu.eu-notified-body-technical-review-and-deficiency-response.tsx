...
export const Route = createFileRoute("/services/eu/eu-notified-body-technical-review-and-deficiency-response")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-notified-body-technical-review-and-deficiency-response" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-notified-body-technical-review-and-deficiency-response" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-notified-body-technical-review-and-deficiency-response",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Deficiency Response", item: "https://www.nkbregovanta.com/services/eu/eu-notified-body-technical-review-and-deficiency-response" },
              ],
            },
          ]),
        }}
