      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4">Medical Device License (MDL)</h1>
            <p className="text-lg text-white/80 leading-relaxed">
              Navigate the complexities of the Canada regulatory landscape with our comprehensive Medical Device License (MDL) support.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The regulatory authority in Canada maintains strict requirements for Medical Device License (MDL). Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the Canada market.
              </p>
