...
export const Route = createFileRoute("/services/eu/european-authorized-representative-ec-rep-ear-services")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/european-authorized-representative-ec-rep-ear-services" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/european-authorized-representative-ec-rep-ear-services" }],
  }),
  component: EUEARPage,
});
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/european-authorized-representative-ec-rep-ear-services",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "EC REP (EAR)", item: "https://www.nkbregovanta.com/services/eu/european-authorized-representative-ec-rep-ear-services" },
              ],
            },
          ]),
        }}
