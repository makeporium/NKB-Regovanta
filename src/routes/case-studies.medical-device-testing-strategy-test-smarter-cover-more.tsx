...
export const Route = createFileRoute("/case-studies/medical-device-testing-strategy-test-smarter-cover-more")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/medical-device-testing-strategy-test-smarter-cover-more" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/medical-device-testing-strategy-test-smarter-cover-more" },
    ],
    scripts: [
      {
...
function Article() {
  return (
    <>
      ...
      <CTABand title="Looking for a smarter test strategy?" description="NKB Regovanta can help." action="Contact Us Today" />
    </>
  );
}
