...
export const Route = createFileRoute('/services/brazil/anvisa-notificacao-pathway-brazil')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-notificacao-pathway-brazil" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-notificacao-pathway-brazil" }],
    scripts: [
      {
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4">ANVISA Notificação Pathway (Brazil)</h1>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                The regulatory authority in Brazil maintains strict requirements for Notificação Pathway. Our team of regulatory experts ensures that your strategy aligns perfectly with the latest guidelines, minimizing delays and mitigating compliance risks in the Brazil market.
              </p>
