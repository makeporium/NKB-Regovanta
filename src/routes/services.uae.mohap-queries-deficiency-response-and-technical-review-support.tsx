...
export const Route = createFileRoute("/services/uae/mohap-queries-deficiency-response-and-technical-review-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/mohap-queries-deficiency-response-and-technical-review-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/mohap-queries-deficiency-response-and-technical-review-support" }],
        scripts: [
      {
