...
export const Route = createFileRoute("/case-studies/australia-tga-artg-inclusion-case-study")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/australia-tga-artg-inclusion-case-study" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/australia-tga-artg-inclusion-case-study" },
    ],
    scripts: [
      {
