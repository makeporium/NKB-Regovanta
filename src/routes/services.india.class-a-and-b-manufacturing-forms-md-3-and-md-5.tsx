...
export const Route = createFileRoute("/services/india/class-a-and-b-manufacturing-forms-md-3-and-md-5")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/class-a-and-b-manufacturing-forms-md-3-and-md-5" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/class-a-and-b-manufacturing-forms-md-3-and-md-5" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Class A & B Manufacturing  (Forms MD-3 & MD-5)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Class A & B Manufacturing  (Forms MD-3 & MD-5)" className="mt-8 w-full" />
        </div>
      </section>
              ...
              <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 sticky top-24">
                ...
                <div className="mt-8 pt-8 border-t border-gray-200">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      <Link to="/services/india/loan-licenses-for-class-a-and-b-forms-md-4-and-md-6" className="text-sm text-blue-600 hover:underline flex items-start gap-2">
                        <FileText className="h-4 w-4 shrink-0 mt-0.5" />
