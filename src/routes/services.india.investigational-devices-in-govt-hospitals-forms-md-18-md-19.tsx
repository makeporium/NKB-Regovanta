...
export const Route = createFileRoute("/services/india/investigational-devices-in-govt-hospitals-forms-md-18-md-19")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/investigational-devices-in-govt-hospitals-forms-md-18-md-19" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/investigational-devices-in-govt-hospitals-forms-md-18-md-19" },
    ],
    scripts: [
      {
