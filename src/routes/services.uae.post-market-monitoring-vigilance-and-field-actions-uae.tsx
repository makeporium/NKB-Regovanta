...
export const Route = createFileRoute("/services/uae/post-market-monitoring-vigilance-and-field-actions-uae")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/post-market-monitoring-vigilance-and-field-actions-uae" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/post-market-monitoring-vigilance-and-field-actions-uae" }],
        scripts: [
      {
