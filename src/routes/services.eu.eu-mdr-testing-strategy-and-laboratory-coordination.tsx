...
export const Route = createFileRoute("/services/eu/eu-mdr-testing-strategy-and-laboratory-coordination")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-testing-strategy-and-laboratory-coordination" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-testing-strategy-and-laboratory-coordination" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-testing-strategy-and-laboratory-coordination",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Testing Strategy", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-testing-strategy-and-laboratory-coordination" },
              ],
            },
          ]),
        }}
