...
export const Route = createFileRoute("/services/india/neutral-code-certificate-special-code")({
    ...
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/neutral-code-certificate-special-code" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/neutral-code-certificate-special-code" },
    ],
    scripts: [
      {
                        ...
                        <div className="lg:col-span-1">
                            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100 sticky top-24">
                                ...
                                <div className="mt-8 pt-8 border-t border-gray-200">
                                    ...
                                    <ul className="space-y-3">
                                        <li>
                                            <Link to="/services/india/free-sale-certificate-fsc" className="text-sm text-blue-600 hover:underline flex items-start gap-2">
