...
export const Route = createFileRoute("/services/brazil/anvisa-portuguese-labeling-udi-and-siud-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-portuguese-labeling-udi-and-siud-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-portuguese-labeling-udi-and-siud-compliance" }],
    scripts: [
      {
