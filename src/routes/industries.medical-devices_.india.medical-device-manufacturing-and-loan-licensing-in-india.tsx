...
export const Route = createFileRoute("/industries/medical-devices_/india/medical-device-manufacturing-and-loan-licensing-in-india")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/industries/medical-devices/india/medical-device-manufacturing-and-loan-licensing-in-india" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/industries/medical-devices/india/medical-device-manufacturing-and-loan-licensing-in-india" },
    ],
    scripts: [
      {
    ...
    <article className="min-h-screen bg-[#f8fafc] text-navy selection:bg-[#0b3a96] selection:text-white pt-24 pb-20 lg:pt-28 lg:pb-28">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-500 font-semibold mb-8">
          ...
          <Link to="/services/india/medical-device-licensing-and-regulatory-approvals-in-india" className="hover:text-[#0b3a96] transition-colors">Medical Devices</Link>
          <ChevronRight className="h-3 w-3" />
