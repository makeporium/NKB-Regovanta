...
export const Route = createFileRoute("/services/canada/health-canada-samd-and-cybersecurity-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-samd-and-cybersecurity-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-samd-and-cybersecurity-compliance" }],
    scripts: [
      {
