...
export const Route = createFileRoute("/insights/eu-mdr-2026-eudamed-classification-and-compliance-priorities")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/insights/eu-mdr-2026-eudamed-classification-and-compliance-priorities" },
      { property: "og:type", content: "article" },
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/database_analytics_eudamed.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/database_analytics_eudamed.jpg" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/insights/eu-mdr-2026-eudamed-classification-and-compliance-priorities" },
    ],
  }),
  component: Article,
});
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "mainEntityOfPage": "https://www.nkbregovanta.com/insights/eu-mdr-2026-eudamed-classification-and-compliance-priorities"
          })
        }}
      />
