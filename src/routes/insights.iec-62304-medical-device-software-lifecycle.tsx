...
export const Route = createFileRoute("/insights/iec-62304-medical-device-software-lifecycle")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/software_code_validation.jpg" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/software_code_validation.jpg" }
    ],
