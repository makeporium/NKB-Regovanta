...
export const Route = createFileRoute("/services/brazil/anvisa-technical-dossier-and-safety-performance-evidence")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-technical-dossier-and-safety-performance-evidence" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-technical-dossier-and-safety-performance-evidence" }],
    scripts: [
      {
