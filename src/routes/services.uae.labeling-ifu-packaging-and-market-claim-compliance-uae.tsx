...
export const Route = createFileRoute("/services/uae/labeling-ifu-packaging-and-market-claim-compliance-uae")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/labeling-ifu-packaging-and-market-claim-compliance-uae" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/labeling-ifu-packaging-and-market-claim-compliance-uae" }],
        scripts: [
      {
