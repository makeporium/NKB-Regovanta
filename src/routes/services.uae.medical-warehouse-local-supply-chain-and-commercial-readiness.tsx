...
export const Route = createFileRoute("/services/uae/medical-warehouse-local-supply-chain-and-commercial-readiness")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/medical-warehouse-local-supply-chain-and-commercial-readiness" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/medical-warehouse-local-supply-chain-and-commercial-readiness" }],
        scripts: [
      {
