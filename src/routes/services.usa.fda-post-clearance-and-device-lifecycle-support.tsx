...
export const Route = createFileRoute("/services/usa/fda-post-clearance-and-device-lifecycle-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-post-clearance-and-device-lifecycle-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-post-clearance-and-device-lifecycle-support" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/fda-post-clearance-and-device-lifecycle-support",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Device Lifecycle", item: "https://www.nkbregovanta.com/services/usa/fda-post-clearance-and-device-lifecycle-support" },
              ],
            },
          ]),
        }}
