...
export const Route = createFileRoute("/services/australia/australian-labelling-ifu-and-ausudid-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/australian-labelling-ifu-and-ausudid-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/australian-labelling-ifu-and-ausudid-compliance" }],
    scripts: [
      {
