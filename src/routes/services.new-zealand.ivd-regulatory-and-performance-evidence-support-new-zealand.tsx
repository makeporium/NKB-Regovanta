...
export const Route = createFileRoute("/services/new-zealand/ivd-regulatory-and-performance-evidence-support-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/ivd-regulatory-and-performance-evidence-support-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/ivd-regulatory-and-performance-evidence-support-new-zealand" }],
    scripts: [
      {
