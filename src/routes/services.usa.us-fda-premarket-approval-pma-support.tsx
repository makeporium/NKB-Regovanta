...
export const Route = createFileRoute("/services/usa/us-fda-premarket-approval-pma-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/us-fda-premarket-approval-pma-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/us-fda-premarket-approval-pma-support" }],
    scripts: [
      {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <div className="bg-blue-50/60 p-6 rounded-2xl border border-blue-200 text-center">
                <h4 className="text-base font-extrabold text-navy mb-2">PMA / De Novo Questions?</h4>
                <p className="text-xs text-navy/70 mb-5 leading-relaxed">
                  Discuss strategic planning with our high-risk medical device team.
                </p>
                <Link
                  to="/contact"
                ...
                >
                  Discuss PMA Strategy <ArrowRight className="h-3.5 w-3.5" />
                </Link>
              </div>
            </div>
          </div>
