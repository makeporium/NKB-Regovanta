...
export const Route = createFileRoute("/services/australia/tga-application-audit-defense-and-rfi-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-application-audit-defense-and-rfi-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-application-audit-defense-and-rfi-support" }],
    scripts: [
      {
