...
export const Route = createFileRoute("/services/australia/tga-testing-strategy-and-laboratory-coordination-australia")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-testing-strategy-and-laboratory-coordination-australia" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-testing-strategy-and-laboratory-coordination-australia" }],
    scripts: [
      {
