...
export const Route = createFileRoute("/services/uae/uae-mohap-regulatory-strategy-and-product-classification")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/uae-mohap-regulatory-strategy-and-product-classification" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/uae-mohap-regulatory-strategy-and-product-classification" }],
        scripts: [
      {
