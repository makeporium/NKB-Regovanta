...
export const Route = createFileRoute('/services/usa/fda-513g-requests-for-information')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-513g-requests-for-information" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-513g-requests-for-information" },
    ],
    scripts: [
      {
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4">FDA 513(g) Requests for Information</h1>
