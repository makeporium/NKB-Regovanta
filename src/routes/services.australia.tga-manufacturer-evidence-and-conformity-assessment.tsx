...
export const Route = createFileRoute("/services/australia/tga-manufacturer-evidence-and-conformity-assessment")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-manufacturer-evidence-and-conformity-assessment" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-manufacturer-evidence-and-conformity-assessment" }],
    scripts: [
      {
