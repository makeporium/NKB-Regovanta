...
export const Route = createFileRoute("/case-studies/converting-a-legacy-technical-file-to-mdr-without-rebuilding-everything-from-zero")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/case-studies/converting-a-legacy-technical-file-to-mdr-without-rebuilding-everything-from-zero" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/case-studies/converting-a-legacy-technical-file-to-mdr-without-rebuilding-everything-from-zero" },
    ],
    scripts: [
      {
