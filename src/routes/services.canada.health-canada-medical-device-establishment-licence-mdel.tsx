...
export const Route = createFileRoute("/services/canada/health-canada-medical-device-establishment-licence-mdel")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-establishment-licence-mdel" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-establishment-licence-mdel" }],
    scripts: [
      {
