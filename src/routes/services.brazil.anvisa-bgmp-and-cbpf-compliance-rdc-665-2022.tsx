...
export const Route = createFileRoute("/services/brazil/anvisa-bgmp-and-cbpf-compliance-rdc-665-2022")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-bgmp-and-cbpf-compliance-rdc-665-2022" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-bgmp-and-cbpf-compliance-rdc-665-2022" }],
    scripts: [
      {
