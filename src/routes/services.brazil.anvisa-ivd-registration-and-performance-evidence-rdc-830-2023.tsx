...
export const Route = createFileRoute("/services/brazil/anvisa-ivd-registration-and-performance-evidence-rdc-830-2023")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-ivd-registration-and-performance-evidence-rdc-830-2023" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-ivd-registration-and-performance-evidence-rdc-830-2023" }],
    scripts: [
      {
