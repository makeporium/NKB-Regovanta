...
export const Route = createFileRoute("/services/brazil/anvisa-notification-and-registration-cadastro-and-registro")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-notification-and-registration-cadastro-and-registro" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-notification-and-registration-cadastro-and-registro" }],
    scripts: [
      {
