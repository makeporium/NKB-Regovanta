...
export const Route = createFileRoute("/services/uk/qms-implementation-and-uk-mdr-alignment")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/qms-implementation-and-uk-mdr-alignment" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/qms-implementation-and-uk-mdr-alignment" }],
    scripts: [
      {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                to="/services/uk/uk-approved-body-and-conformity-assessment-readiness"
