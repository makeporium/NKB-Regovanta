...
export const Route = createFileRoute("/services/saudi-arabia/changes-renewal-and-lifecycle-support-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/changes-renewal-and-lifecycle-support-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/changes-renewal-and-lifecycle-support-sfda" }],
        scripts: [
      {
