...
export const Route = createFileRoute("/services/saudi-arabia/technical-documentation-and-essential-principles-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/technical-documentation-and-essential-principles-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/technical-documentation-and-essential-principles-sfda" }],
        scripts: [
      {
