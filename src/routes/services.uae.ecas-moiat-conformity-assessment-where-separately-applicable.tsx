...
export const Route = createFileRoute("/services/uae/ecas-moiat-conformity-assessment-where-separately-applicable")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/ecas-moiat-conformity-assessment-where-separately-applicable" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/ecas-moiat-conformity-assessment-where-separately-applicable" }],
        scripts: [
      {
