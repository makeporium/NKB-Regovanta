...
export const Route = createFileRoute("/services/india/ivd-clinical-performance-evaluations-forms-md-24-md-25")({
  component: IVDClinicalPerformancePage,
  head: () => ({
    meta: [
      { name: "robots", content: "index, follow, max-image-preview:large" },
      { title: "CDSCO IVD Clinical Performance (MD-24/25) | NKB Regovanta" },
      { name: "description", content: "CDSCO consulting for IVD Clinical Performance Evaluation under Forms MD-24 & MD-25 in India. Protocol review, ethics liaison, and approval support." },
      { property: "og:title", content: "CDSCO IVD Clinical Performance (MD-24/25) | NKB Regovanta" },
      { property: "og:description", content: "CDSCO consulting for IVD Clinical Performance Evaluation under Forms MD-24 & MD-25 in India. Protocol review, ethics liaison, and approval support." },

      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/ivd-clinical-performance-evaluations-forms-md-24-md-25" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CDSCO IVD Clinical Performance (MD-24/25) | NKB Regovanta" },
      { name: "twitter:description", content: "CDSCO consulting for IVD Clinical Performance Evaluation under Forms MD-24 & MD-25 in India. Protocol review, ethics liaison, and approval support." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/ivd-clinical-performance-evaluations-forms-md-24-md-25" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "CDSCO IVD Clinical Performance Evaluation",
          description: "CDSCO consulting for IVD Clinical Performance Evaluation under Forms MD-24 & MD-25 in India.",
          provider: {
            "@type": "Organization",
            name: "NKB Regovanta",
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="IVD Clinical Performance Evaluations  (Forms MD-24, MD-25)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="IVD Clinical Performance Evaluations  (Forms MD-24, MD-25)" className="mt-8 w-full" />
        </div>
      </section>
