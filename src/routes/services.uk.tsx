...
const keyOfferings = [
    { title: "MHRA Device Registration", desc: "We oversee your entire registration lifecycle via the DORS platform, delivering precision-engineered submissions that secure timely MHRA approvals across all medical device classifications." },
    { title: "UK Responsible Person (UKRP)", desc: "Serving as your mandated UKRP, we act as your legal representative to the MHRA, expertly managing all regulatory communications and upholding continuous vigilance monitoring." },
    { title: "Technical File & Dossier Compilation", desc: "Our regulatory team expertly constructs and reviews Technical Files to align seamlessly with UK regulations and UKCA marking standards, ensuring total readiness for regulatory audits and submissions." },
    { title: "QMS Implementation Support", desc: "We guide the development, integration, and maintenance of ISO 13485-certified Quality Management Systems, specifically adapted to satisfy UK MDR prerequisites and MHRA compliance expectations." },
    { title: "Advanced Regulatory Writing", desc: "NKB Regovanta delivers specialized medical writing services, including Clinical Evaluation Reports (CERs), Post-Market Surveillance (PMS) plans, PSURs, and comprehensive risk management files, guaranteeing technical accuracy." },
    { title: "Labeling & Artwork Compliance", desc: "We meticulously audit your Instructions for Use (IFUs), product labeling, and packaging design to verify strict alignment with UKCA symbology, formatting, and language requirements." },
    { title: "Post-Market Surveillance (PMS)", desc: "We facilitate all ongoing PMS obligations, seamlessly handling adverse event reporting, vigilance coordination, and implementing MHRA regulatory updates to safeguard your ongoing market authorization." }
];

const ukrpOfferings = [
    { title: "Device Registration via DORS", desc: "We drive the end-to-end MHRA registration process through the Device Online Registration System (DORS), confirming that every product in your portfolio is accurately cataloged, verified, and legally permitted for UK commercialization." },
    { title: "Documentation & Conformity Assurance", desc: "Our experts meticulously curate and retain your Declarations of Conformity, technical files, and product certificates, ensuring this critical documentation is instantly available for MHRA review upon formal request." },
    { title: "MHRA Communication Liaison", desc: "We serve as the definitive frontline for all MHRA communications, delivering prompt, technically precise responses to agency inquiries, clarification requests, and post-market compliance reviews on your behalf." },
    { title: "Vigilance & Incident Coordination", desc: "As your UKRP, we act as the central liaison for all safety-related occurrences. We efficiently coordinate with the manufacturer, healthcare providers, and the MHRA to manage adverse event reporting and execute Field Safety Corrective Actions." },
    { title: "Inspection & Audit Readiness", desc: "We proactively organize and maintain all regulatory records and official correspondence. In the event of an MHRA audit, we ensure your technical dossiers, labeling records, and post-market data are fully prepped and immediately accessible." }
];
