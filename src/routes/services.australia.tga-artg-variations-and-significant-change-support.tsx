...
export const Route = createFileRoute("/services/australia/tga-artg-variations-and-significant-change-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-artg-variations-and-significant-change-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-artg-variations-and-significant-change-support" }],
    scripts: [
      {
