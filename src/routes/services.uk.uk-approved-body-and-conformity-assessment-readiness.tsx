...
export const Route = createFileRoute("/services/uk/uk-approved-body-and-conformity-assessment-readiness")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/uk-approved-body-and-conformity-assessment-readiness" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/uk-approved-body-and-conformity-assessment-readiness" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/uk/uk-approved-body-and-conformity-assessment-readiness",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Approved Body Readiness", item: "https://www.nkbregovanta.com/services/uk/uk-approved-body-and-conformity-assessment-readiness" },
              ],
            },
          ]),
        }}
