...
export const Route = createFileRoute("/services/eu/eu-post-market-surveillance-pms-and-vigilance-support")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-post-market-surveillance-pms-and-vigilance-support" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-post-market-surveillance-pms-and-vigilance-support" }],
    scripts: [
      {
