...
export const Route = createFileRoute("/services/australia/tga-post-market-vigilance-mdir-and-recall-management")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-post-market-vigilance-mdir-and-recall-management" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-post-market-vigilance-mdir-and-recall-management" }],
    scripts: [
      {
