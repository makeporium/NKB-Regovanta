...
export const Route = createFileRoute("/insights/human-factors-engineering-medical-device-design")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Human Factors in Medical Device Design | NKB Regovanta" },
      ...
      { property: "og:image", content: "https://www.nkbregovanta.com/assets/insights/medical_ergonomics_device.jpg" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Human Factors in Medical Device Design | NKB Regovanta" },
      ...
      { name: "twitter:image", content: "https://www.nkbregovanta.com/assets/insights/medical_ergonomics_device.jpg" }
    ],
