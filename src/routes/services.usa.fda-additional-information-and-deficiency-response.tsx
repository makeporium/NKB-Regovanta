...
export const Route = createFileRoute("/services/usa/fda-additional-information-and-deficiency-response")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/fda-additional-information-and-deficiency-response" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/fda-additional-information-and-deficiency-response" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/fda-additional-information-and-deficiency-response",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Deficiency Response", item: "https://www.nkbregovanta.com/services/usa/fda-additional-information-and-deficiency-response" },
              ],
            },
          ]),
        }}
