...
export const Route = createFileRoute("/services/saudi-arabia/samd-software-ai-and-cybersecurity-sfda")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/saudi-arabia/samd-software-ai-and-cybersecurity-sfda" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/saudi-arabia/samd-software-ai-and-cybersecurity-sfda" }],
        scripts: [
      {
