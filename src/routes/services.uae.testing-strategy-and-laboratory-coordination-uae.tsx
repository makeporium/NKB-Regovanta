...
export const Route = createFileRoute("/services/uae/testing-strategy-and-laboratory-coordination-uae")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/testing-strategy-and-laboratory-coordination-uae" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/testing-strategy-and-laboratory-coordination-uae" }],
        scripts: [
      {
