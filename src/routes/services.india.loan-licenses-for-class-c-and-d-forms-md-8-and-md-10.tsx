...
export const Route = createFileRoute("/services/india/loan-licenses-for-class-c-and-d-forms-md-8-and-md-10")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Obtain CDSCO MD-8 & MD-10 loan manufacturing licenses for Class C & D medical devices in India. End-to-end CLA application and facility audit support." },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/loan-licenses-for-class-c-and-d-forms-md-8-and-md-10" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "CDSCO Class C & D Loan Manufacturing | NKB Regovanta" },
      { name: "twitter:description", content: "Obtain CDSCO MD-8 & MD-10 loan manufacturing licenses for Class C & D medical devices in India. End-to-end CLA application and facility audit support." },
      { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
    ],
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/loan-licenses-for-class-c-and-d-forms-md-8-and-md-10" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Service",
          name: "CDSCO Loan License for Class C & D Devices (MD-8 & MD-10)",
          description: "Obtain CDSCO MD-8 and MD-10 loan manufacturing licenses for high-risk Class C and D medical devices in India.",
          provider: {
            "@type": "Organization",
            name: "NKB Regovanta",
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Loan Licenses for Class C & D  (Forms MD-8 & MD-10)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Loan Licenses for Class C & D  (Forms MD-8 & MD-10)" className="mt-8 w-full" />
        </div>
      </section>
              ...
              <div className="bg-navy rounded-2xl p-8 border border-gray-100 sticky top-24 text-white">
                ...
                <div className="mt-8 pt-8 border-t border-white/20">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link to="/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9" className="text-sm text-gold hover:underline flex items-start gap-2">
