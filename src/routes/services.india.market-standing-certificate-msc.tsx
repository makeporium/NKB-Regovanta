...
export const Route = createFileRoute("/services/india/market-standing-certificate-msc")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/market-standing-certificate-msc" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/market-standing-certificate-msc" },
    ],
    scripts: [
      {
    ...
    <div className="bg-white">
      ...
      <section className="bg-[#f7f9fc]">
        ...
        <div className="@container relative hidden md:block">
          <img width={1942} height={745} src={heroImg} alt="Market Standing Certificate  (MSC)" className="block w-full" />
        ...
        <div className="md:hidden px-4 pt-12 pb-8 sm:px-6">
          ...
          <img width={1942} height={745} src={heroImg} alt="Market Standing Certificate  (MSC)" className="mt-8 w-full" />
        </div>
      </section>
              ...
              <div className="bg-navy rounded-2xl p-8 border border-gray-100 sticky top-24 text-white">
                ...
                <div className="mt-8 pt-8 border-t border-white/20">
                  ...
                  <ul className="space-y-3">
                    ...
                    <li>
                      <Link to="/services/india/free-sale-certificate-fsc" className="text-sm text-gold hover:underline flex items-start gap-2">
                        <FileText className="h-4 w-4 shrink-0 mt-0.5" />
