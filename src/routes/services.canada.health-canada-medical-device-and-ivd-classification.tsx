...
export const Route = createFileRoute("/services/canada/health-canada-medical-device-and-ivd-classification")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-and-ivd-classification" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-medical-device-and-ivd-classification" }],
    scripts: [
      {
