...
export const Route = createFileRoute("/services/canada/health-canada-ivd-registration-and-performance-strategy")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-ivd-registration-and-performance-strategy" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-ivd-registration-and-performance-strategy" }],
    scripts: [
      {
