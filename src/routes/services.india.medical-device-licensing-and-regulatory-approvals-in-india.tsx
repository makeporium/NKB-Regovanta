...
export const Route = createFileRoute("/services/india/medical-device-licensing-and-regulatory-approvals-in-india")({
  head: () => ({
        meta: [
            { title: "CDSCO Medical Device Licensing & Approvals | NKB Regovanta" },
            {
                name: "description",
                content: "Comprehensive CDSCO medical device licensing support in India: MD-14/15 import, MD-3 to MD-9 manufacturing, loan licenses, and Authorized Agent (AIR).",
            },
            { property: "og:title", content: "CDSCO Medical Device Licensing & Approvals | NKB Regovanta" },
            {
                property: "og:description",
                content: "Comprehensive CDSCO medical device licensing support in India: MD-14/15 import, MD-3 to MD-9 manufacturing, loan licenses, and Authorized Agent (AIR).",
            },
            { property: "og:url", content: "https://www.nkbregovanta.com/services/india/medical-device-licensing-and-regulatory-approvals-in-india" },
            { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
            { name: "twitter:card", content: "summary_large_image" },
            { name: "twitter:title", content: "CDSCO Medical Device Licensing & Approvals | NKB Regovanta" },
            { name: "twitter:description", content: "Comprehensive CDSCO medical device licensing support in India: MD-14/15 import, MD-3 to MD-9 manufacturing, loan licenses, and Authorized Agent (AIR).", },
            { name: "twitter:image", content: "https://www.nkbregovanta.com/og-image.png" },
        ],
        links: [
            { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/medical-device-licensing-and-regulatory-approvals-in-india" },
        ],
    }),
          ...
          __html: JSON.stringify([
            {
              ...
              "@type": "Service",
              "name": "Medical Device Consultant & Regulatory Consultancy India",
              "alternateName": ["Medical Device Consultant", "Medical Device Consultancy", "CDSCO Regulatory Consultant"],
              "url": "https://www.nkbregovanta.com/services/india/medical-device-licensing-and-regulatory-approvals-in-india",
              "description": "Full-spectrum CDSCO medical device consultant and regulatory consultancy services in India covering import licensing, manufacturing approvals, and Indian Authorized Agent representation.",
              "provider": {
            ...
            },
            {
              ...
              "itemListElement": [
                ...
                { "@type": "ListItem", "position": 2, "name": "India CDSCO", "item": "https://www.nkbregovanta.com/services/india" },
                { "@type": "ListItem", "position": 3, "name": "Medical Devices", "item": "https://www.nkbregovanta.com/services/india/medical-device-licensing-and-regulatory-approvals-in-india" }
              ]
            }
          ])
        }}
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
              Medical Device <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 via-blue-100 to-amber-200">Licensing & Regulatory Approvals</span> in India
            </h1>

            <p className="mt-6 text-base sm:text-lg lg:text-xl text-blue-100/80 leading-relaxed max-w-3xl">
              As a premier medical device consultant and regulatory consultancy, NKB Regovanta delivers end-to-end CDSCO market access—from risk-based Class A–D classification and SUGAM online portal filings to Authorized Indian Representative (AIR) representation, Central & State FDA manufacturing licenses, and clinical investigation permissions across India.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 border-t-4 border-emerald-500 shadow-sm hover:shadow-md transition-all">
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-emerald-700 font-semibold">
                ...
                <Link to="/services/india/class-a-import-registration-as-per-gsr-777e" className="hover:underline flex items-center gap-1">
            ...
            <div className="bg-white rounded-2xl p-6 border-t-4 border-blue-500 shadow-sm hover:shadow-md transition-all">
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-blue-700 font-semibold">
                ...
                <Link to="/services/india/class-a-and-b-manufacturing-forms-md-3-and-md-5" className="hover:underline flex items-center gap-1">
                  View Form <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 border-t-4 border-amber-500 shadow-sm hover:shadow-md transition-all">
              ...
              <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between text-xs text-amber-700 font-semibold">
                ...
                <Link to="/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9" className="hover:underline flex items-center gap-1">
                  View Form <ArrowRight className="h-3 w-3" />
                </Link>
              </div>
            </div>
      ...
      <section id="for-importers" className="py-16 sm:py-20 bg-[#f8fafc] border-t border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <Link
              to="/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india"
          ...
          <div className="bg-white rounded-3xl border border-gray-200 p-6 sm:p-8 shadow-xs">
            ...
            {activeImporterTab === "import" && (
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    to="/services/india/class-a-import-registration-as-per-gsr-777e"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0b3a96] hover:underline"
                  >
            ...
            {activeImporterTab === "test" && (
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    to="/services/india/patient-personal-use-device-import-forms-md-20-md-21"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0b3a96] hover:underline"
                  >
      ...
      <section id="for-manufacturers" className="py-16 sm:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <Link
              to="/services/india/class-a-and-b-manufacturing-forms-md-3-and-md-5"
              className="inline-flex items-center gap-1.5 text-sm font-bold text-[#0b3a96] hover:text-[#082b70] shrink-0"
            >
          ...
          <div className="bg-[#f8fafc] rounded-3xl border border-gray-200 p-6 sm:p-8 shadow-xs">
            ...
            {activeMfgTab === "ab" && (
              <div className="space-y-4">
                ...
                <div className="pt-2 flex gap-4 text-xs font-bold text-[#0b3a96]">
                  ...
                  <Link to="/services/india/loan-licenses-for-class-a-and-b-forms-md-4-and-md-6" className="hover:underline flex items-center gap-1">
            ...
            {activeMfgTab === "cd" && (
              <div className="space-y-4">
                ...
                <div className="pt-2 flex gap-4 text-xs font-bold text-[#0b3a96]">
                  ...
                  <Link to="/services/india/loan-licenses-for-class-c-and-d-forms-md-8-and-md-10" className="hover:underline flex items-center gap-1">
            ...
            {activeMfgTab === "test" && (
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Link
                    to="/services/india/investigational-devices-in-govt-hospitals-forms-md-18-md-19"
                    className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0b3a96] hover:underline"
                  >
          ...
          <div className="bg-white/10 border border-white/15 rounded-3xl p-6 sm:p-8 backdrop-blur-md">
            ...
            {activeNewDeviceTab === "no-predicate" && (
              <div className="space-y-3 text-sm text-blue-100/90">
                ...
                <div className="pt-2">
                  <Link
                    to="/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9"
                    className="inline-flex items-center gap-1 text-xs font-bold text-[#F5C754] hover:underline"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/services/india/class-a-import-registration-as-per-gsr-777e" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/services/india/class-c-and-d-manufacturing-forms-md-7-and-md-9" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
                <a href="#enquiry-form" className="px-3 py-1.5 rounded-lg bg-[#0b3a96] text-white text-xs font-bold hover:bg-[#082b70] transition-colors">
                  Enquire Now
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/services/india/patient-personal-use-device-import-forms-md-20-md-21" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
                <a href="#enquiry-form" className="px-3 py-1.5 rounded-lg bg-[#0b3a96] text-white text-xs font-bold hover:bg-[#082b70] transition-colors">
                  Enquire Now
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/services/india/md-42-medical-device-registration-certificate" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
                <a href="#enquiry-form" className="px-3 py-1.5 rounded-lg bg-[#0b3a96] text-white text-xs font-bold hover:bg-[#082b70] transition-colors">
                  Enquire Now
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
                <a href="#enquiry-form" className="px-3 py-1.5 rounded-lg bg-[#0b3a96] text-white text-xs font-bold hover:bg-[#082b70] transition-colors">
                  Enquire Now
            ...
            <div className="bg-[#f8fafc] p-6 rounded-2xl border border-gray-200 hover:border-blue-300 hover:shadow-md transition-all flex flex-col justify-between">
              ...
              <div className="mt-5 pt-4 border-t border-gray-200 flex items-center justify-between">
                <Link to="/services/india/free-sale-certificate-fsc" className="text-xs font-bold text-[#0b3a96] hover:underline">
                  Read More
                </Link>
                <a href="#enquiry-form" className="px-3 py-1.5 rounded-lg bg-[#0b3a96] text-white text-xs font-bold hover:bg-[#082b70] transition-colors">
                  Enquire Now
