...
export const Route = createFileRoute("/services/uae/change-management")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "UAE MOHAP Changes, Variations, Renewals & Lifecycle Support, services uae change management, NKB Regovanta, regulatory consultant, medical device" },
      { property: "og:title", content: "UAE MOHAP Changes, Variations, Renewals & Lifecycle Support | NKB Regovanta" },
      { property: "og:description", content: "MOHAP variation notifications and medical equipment registration renewals in the UAE. Design modifications, manufacturing transfers, renewal filings, and technical file updates." },
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/change-management" },
      { property: "og:type", content: "website" },
      { property: "og:image", content: "https://www.nkbregovanta.com/og-image.png" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "UAE MOHAP Changes, Variations, Renewals & Lifecycle Support | NKB Regovanta" },
      { name: "twitter:description", content: "MOHAP variation notifications and medical equipment registration renewals in the UAE. Design modifications, manufacturing transfers, renewal filings, and technical file updates." },
