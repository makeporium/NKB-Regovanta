...
export const Route = createFileRoute("/services/india/test-license-for-ivd-devices-forms-md-16-md-17")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/india/test-license-for-ivd-devices-forms-md-16-md-17" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/india/test-license-for-ivd-devices-forms-md-16-md-17" },
    ],
    scripts: [
      {
