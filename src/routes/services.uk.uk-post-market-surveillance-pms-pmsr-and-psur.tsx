...
export const Route = createFileRoute("/services/uk/uk-post-market-surveillance-pms-pmsr-and-psur")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/uk-post-market-surveillance-pms-pmsr-and-psur" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/uk-post-market-surveillance-pms-pmsr-and-psur" }],
  }),
  component: UKPMSPage,
});
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/uk/uk-post-market-surveillance-pms-pmsr-and-psur",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Post-Market Surveillance", item: "https://www.nkbregovanta.com/services/uk/uk-post-market-surveillance-pms-pmsr-and-psur" },
              ],
            },
          ]),
        }}
