...
export const Route = createFileRoute("/services/uae/technical-documentation-and-safety-performance-evidence-uae-mohap")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uae/technical-documentation-and-safety-performance-evidence-uae-mohap" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uae/technical-documentation-and-safety-performance-evidence-uae-mohap" }],
        scripts: [
      {
