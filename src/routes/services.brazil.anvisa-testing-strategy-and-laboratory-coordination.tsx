...
export const Route = createFileRoute("/services/brazil/anvisa-testing-strategy-and-laboratory-coordination")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/brazil/anvisa-testing-strategy-and-laboratory-coordination" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/brazil/anvisa-testing-strategy-and-laboratory-coordination" }],
    scripts: [
      {
