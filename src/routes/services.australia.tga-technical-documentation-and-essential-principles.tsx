...
export const Route = createFileRoute("/services/australia/tga-technical-documentation-and-essential-principles")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/australia/tga-technical-documentation-and-essential-principles" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/australia/tga-technical-documentation-and-essential-principles" }],
    scripts: [
      {
