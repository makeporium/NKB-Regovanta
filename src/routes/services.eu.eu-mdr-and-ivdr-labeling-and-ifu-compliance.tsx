...
export const Route = createFileRoute("/services/eu/eu-mdr-and-ivdr-labeling-and-ifu-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-labeling-and-ifu-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-labeling-and-ifu-compliance" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-labeling-and-ifu-compliance",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Labeling & IFU", item: "https://www.nkbregovanta.com/services/eu/eu-mdr-and-ivdr-labeling-and-ifu-compliance" },
              ],
            },
          ]),
        }}
