...
export const Route = createFileRoute('/services/canada/health-canada-mdl-and-mdel-annual-renewals')({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-mdl-and-mdel-annual-renewals" },
    ...
    links: [
      { rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-mdl-and-mdel-annual-renewals" },
    ],
    scripts: [
      {
      ...
      <section className="relative py-16 bg-navy text-white overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-3xl md:text-5xl font-extrabold text-white tracking-tight mb-4">Health Canada MDL &amp; MDEL Annual Renewals</h1>
