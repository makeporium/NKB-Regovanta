...
export const Route = createFileRoute("/services/usa/us-fda-medical-device-testing-strategy-and-standards-compliance")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/usa/us-fda-medical-device-testing-strategy-and-standards-compliance" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/usa/us-fda-medical-device-testing-strategy-and-standards-compliance" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/usa/us-fda-medical-device-testing-strategy-and-standards-compliance",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "US FDA Testing Strategy", item: "https://www.nkbregovanta.com/services/usa/us-fda-medical-device-testing-strategy-and-standards-compliance" },
              ],
            },
          ]),
        }}
