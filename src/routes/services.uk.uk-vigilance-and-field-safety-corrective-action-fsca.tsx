...
export const Route = createFileRoute("/services/uk/uk-vigilance-and-field-safety-corrective-action-fsca")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/uk-vigilance-and-field-safety-corrective-action-fsca" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/uk-vigilance-and-field-safety-corrective-action-fsca" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/uk/uk-vigilance-and-field-safety-corrective-action-fsca",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Vigilance & FSCA", item: "https://www.nkbregovanta.com/services/uk/uk-vigilance-and-field-safety-corrective-action-fsca" },
              ],
            },
          ]),
        }}
