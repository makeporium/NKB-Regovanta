...
export const Route = createFileRoute("/services/canada/health-canada-testing-strategy-and-laboratory-coordination")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/canada/health-canada-testing-strategy-and-laboratory-coordination" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/canada/health-canada-testing-strategy-and-laboratory-coordination" }],
    scripts: [
      {
