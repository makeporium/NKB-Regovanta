...
export const Route = createFileRoute("/services/new-zealand/post-market-surveillance-adverse-events-and-recall-support-new-zealand")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/new-zealand/post-market-surveillance-adverse-events-and-recall-support-new-zealand" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/new-zealand/post-market-surveillance-adverse-events-and-recall-support-new-zealand" }],
    scripts: [
      {
