...
export const Route = createFileRoute("/services/uk/uk-mdr-technical-documentation-and-gap-assessment")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.nkbregovanta.com/services/uk/uk-mdr-technical-documentation-and-gap-assessment" },
    ...
    links: [{ rel: "canonical", href: "https://www.nkbregovanta.com/services/uk/uk-mdr-technical-documentation-and-gap-assessment" }],
  }),
          ...
          __html: JSON.stringify([
            {
              ...
              url: "https://www.nkbregovanta.com/services/uk/uk-mdr-technical-documentation-and-gap-assessment",
              description:
            ...
            },
            {
              ...
              itemListElement: [
                ...
                { "@type": "ListItem", position: 4, name: "Technical File", item: "https://www.nkbregovanta.com/services/uk/uk-mdr-technical-documentation-and-gap-assessment" },
              ],
            },
          ]),
        }}
