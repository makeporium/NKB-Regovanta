                  ...
                  <div className="space-y-2.5">
                    ...
                    <ul className="space-y-2">
                      {[
                        ...
                        { label: "Loan Licence – Class A & B – MD-4 / MD-6", to: "/services/india/loan-class-a-b" },
                        { label: "Loan Licence – Class C & D – MD-8 / MD-10", to: "/services/india/loan-class-c-d" },
                        { label: "Manufacturing Facility Regulatory Readiness", to: "/industries/medical-devices/india/for-manufacturer" },
                        { label: "CDSCO Manufacturing Licence Support", to: "/industries/medical-devices/india/for-manufacturer" },
                        { label: "SUGAM Portal Registration & Application Support", to: "/services/india" },
