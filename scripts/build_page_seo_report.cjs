...
const priorityActions = {
  ...
  "/services/usa/us-agent-services-for-foreign-establishments": "Verify the named U.S. person or entity, physical place of business, consent process, and contact details required for the service claim.",
  "/services/usa/fda-estar-dossier-preparation-and-submission": "Use page-filtered GSC queries to choose additions. Add original eSTAR workflow evidence and a real engagement example.",
  "/services/usa/fda-510k-premarket-notification-and-clearance-consulting": "Use page-filtered GSC queries to define its commercial keyword ownership and add genuine 510(k) experience evidence.",
  "/services/india/medical-device-licensing-and-regulatory-approvals-in-india": "Strong technical base. Test 'registration' in title only after exporting this page's actual GSC queries; add verified CDSCO case evidence.",
};
...
function buildMarkdown(pages) {
  ...
  const lines = [
    ...
    "",
    "- **Commercial India importer page:** /industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india received 212 impressions at average position 73.7. Relevant queries include 'import license for medical devices in india' (38 impressions, position 70.3), 'medical device import licenses in india' (24, 74.1), 'indian authorized agent' (20, 62.3), and 'medical device import process in india' (19, 71.9). Google understands the topic, but the page lacks competitive strength.",
    "- **India medical-device hub:** /services/india/medical-device-licensing-and-regulatory-approvals-in-india is indexed and received 31 impressions at average position 12.4. Only six impressions were disclosed by query, including five branded impressions at position 1.6. The aggregate position therefore does not prove page-one visibility for broad CDSCO terms.",
    ...
    "- **FDA 510(k):** /services/usa/fda-510k-premarket-notification-and-clearance-consulting is indexed and appears for correctly aligned 510(k) and premarket-notification queries, generally at positions 56 to 76.",
    "- **FDA eSTAR:** /services/usa/fda-estar-dossier-preparation-and-submission appears for relevant eSTAR submission terms, generally at positions 60 to 80.",
    "- **FDA US Agent:** /services/usa/us-agent-services-for-foreign-establishments received 403 impressions at average position 75 for correctly aligned terms such as 'fda registration agent', 'fda agent', and 'fda us agent'. Verify the real US entity, place of business, and operating evidence behind the service claim.",
    ...
    "",
    "The commercial importer page and /services/india/patient-personal-use-device-import-forms-md-20-md-21 both appeared for 'medical device import license' and 'import license for medical devices in india'. The personal-use page also appeared for broad terms such as 'medical device license india' and 'cdsco import license'. Its title, description, social metadata, schema description, H1, image text, and visible clarification now specify an individual patient's limited-quantity MD-20/21 pathway. A prominent contextual link directs manufacturers, authorized agents, and commercial importers to the MD-14/15 importer page. Preserve both pages and monitor whether commercial query ownership consolidates after recrawling.",
    "",
    ...
    "",
    "1. **https://www.nkbregovanta.com/services/india/patient-personal-use-device-import-forms-md-20-md-21** - request again because its title, description, H1, schema wording, visible clarification, and commercial-import link changed.",
    "2. **https://www.nkbregovanta.com/industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india** - request again so Google processes the strengthened commercial MD-14/15 page relationship and consolidates commercial import intent here.",
    ...
    "",
    "- **/services/india/medical-device-licensing-and-regulatory-approvals-in-india** is already on Google. Improve authority and monitor non-brand queries instead of repeatedly requesting indexing.",
    "- **/services/usa/fda-510k-premarket-notification-and-clearance-consulting** is already on Google and appears for relevant 510(k) queries.",
    "- **/services/usa/fda-estar-dossier-preparation-and-submission** already receives relevant eSTAR impressions.",
    "- **/services/usa/us-agent-services-for-foreign-establishments** already receives relevant US Agent impressions.",
    ...
    "",
    "- Keep /industries/medical-devices/india/medical-device-regulatory-solutions-for-importers-in-india focused on commercial CDSCO MD-14/15 importing, Indian Authorized Agent responsibilities, SUGAM submissions, documents, process, timelines, and importer/manufacturer roles.",
    "- Keep /services/india/patient-personal-use-device-import-forms-md-20-md-21 focused on one patient's limited-quantity MD-20/21 pathway, prescriptions, justification, documentation, and limitations.",
    ...
    "- Keep /services/usa/fda-510k-premarket-notification-and-clearance-consulting, /services/usa/fda-estar-dossier-preparation-and-submission, and /services/usa/us-agent-services-for-foreign-establishments separated by their distinct FDA intents.",
    "",
