...
const CUSTOM_DESCRIPTIONS = {
  ...
  'case-studies.using-predicate-and-material-equivalence-to-avoid-repeating-biocompatibility-testing-without-regulatory-need.tsx': 'How NKB Regovanta resolved a critical FDA 510(k) biocompatibility deficiency using literature equivalence — avoiding $120,000 in redundant testing and achieving clearance in 45 days. A strategic US FDA case study.',
  'case-studies.avoiding-duplicate-simulated-use-work-by-leveraging-an-already-marketed-safety-feature.tsx': 'NKB Regovanta designed a single FDA 510(k) test protocol covering three substantial equivalence arguments with one shared simulated-use usability study — saving client time and budget across multiple device classes.',
